  ...
  <div id="puzzle" ref="puzzle" style="display:inline-block;">
    <div class="puzzle-container" :style="'border-radius:'+16*scale+'px;'">
      <div :style="'position:relative;overflow:hidden;width:'+ dataWidth +'px;'">
        ...
        <p class="ver-tips" ref="verTips" :style="'height: '+22*scale+'px;line-height:'+22*scale+'px;bottom: ' + (displayTips ? 0 : -22*scale ) +'px;'">
    ...
    <div class="slider-container" :style="'width:' + dataWidth + 'px;'">
      ...
      <div class="slider-btn" ref="sliderBtn" @mousedown="startMove" @touchstart="startMove" :style="'top: '+ -7*scale + 'px;'">
          <Icon type="md-log-in" size="24" color="#2db7f5"/>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    moving (e) {
      let self = this
      e = e || window.event
      let moveX = e.pageX || e.targetTouches && e.targetTouches[0] && e.targetTouches[0].pageX
